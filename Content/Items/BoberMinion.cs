...
namespace PolandMod.Content.Items
{
    ...
    public class BoberMinion : ModProjectile
    {
        ...
        private void GeneralBehavior(Player owner, out Vector2 vectorToIdlePosition, out float distanceToIdlePosition)
        {
            ...
            idlePosition.Y -= -48f;
            //if your minion doesnt aimlessly move around when its idle, you need
            // to put it into the line of other summoned minions
            ...
            //If your minion is flying, you want to do this indepentently of any conditions
