...
{
    // This file contains all the code necessary for the projectile of the weapon
    public class RoyalSheathProjectile : ModProjectile
	{
        ...
        private void Visuals()
        {
            ...
            // Spawn glowing diamond dust
            if (Main.rand.NextBool(2)) // 50% chance each frame for a lighter effect
            {
                Dust dust = Dust.NewDustDirect(
                    ...
                    150, // alpha (lower = more opaque)
                    default,
                    1.2f // scale
                );
                dust.noGravity = true; // Makes the dust float/glow
                dust.velocity *= 0.5f; // Slow down the dust for a trailing effect
            }
        }
